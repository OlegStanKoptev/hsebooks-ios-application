//
//  BookBaseRequest+CoreDataClass.swift
//  BookExchange
//
...
@objc(BookBaseRequest)
public class BookBaseRequest: NSManagedObject, Decodable {
...
extension BookBaseRequest {
    enum CodingKeys: String, CodingKey {
        case author, bookIds, creationDate, creatorId, genreIds, id, language, numberOfPages, photoId, publishYear, rating, title, wishersIds, status
