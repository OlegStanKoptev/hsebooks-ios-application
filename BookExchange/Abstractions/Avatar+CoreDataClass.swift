...
@objc(Avatar)
public class Avatar: NSManagedObject, Decodable {
    required convenience public init(from decoder: Decoder) throws {
        ...
        avatarOwnerId = try container.decode(Int64.self, forKey: .avatarOwnerId)
...
extension Avatar {
    enum CodingKeys: String, CodingKey {
        case avatarOwnerId, creationDate, creatorId, id, image
    }
}
